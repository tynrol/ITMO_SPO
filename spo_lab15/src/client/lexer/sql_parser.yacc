...
%type <node> line select insert create update table drop select_stmt update_stmt insert_stmt create_stmt from_stmt into_stmt delete_stmt
...
drop: delete_stmt table_name {
    $$ = new_ast_node(DELETE, "drop", $2, NULL);
};
